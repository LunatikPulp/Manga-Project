                    ...
                    <div className="max-h-60 overflow-y-auto space-y-2 bg-base p-2 rounded-lg border border-overlay">
                        {processedChapters.map(ch => (
                            <div key={ch.id} className="text-sm p-2 bg-overlay rounded-md">
                                ...
                                <span className="text-muted"> — {ch.content.length} страниц</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-surface rounded-xl shadow-2xl w-full max-w-lg border border-overlay"
                    >
                        ...
                        <div className="p-4 bg-base/50 rounded-b-xl flex justify-end gap-3">
                            ...
                            <button
                                ...
                                className="px-4 py-2 text-sm font-semibold bg-brand text-white rounded-lg hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Добавить главы
                            </button>
                        </div>

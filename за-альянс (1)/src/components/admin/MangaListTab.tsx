                    ...
                    <tbody className="divide-y divide-overlay">
                        ...
                        <tr key={manga.id} className="hover:bg-overlay transition-colors">
                            ...
                            <div className="flex gap-2">
                                <button onClick={() => navigate(`/manga/${manga.id}/edit`)} className="text-sm bg-base hover:bg-blue-900/50 text-brand font-semibold py-1 px-3 rounded-md transition-colors">Редактировать</button>
                                <button onClick={() => openDeleteModal(manga)} className="text-sm bg-base hover:bg-red-900/50 text-brand-accent font-semibold py-1 px-3 rounded-md transition-colors">Удалить</button>
                            </div>
                            </td>
                        </tr>
                        ))}

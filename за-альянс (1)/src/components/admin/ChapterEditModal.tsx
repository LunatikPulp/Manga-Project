      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-surface rounded-xl shadow-2xl w-full max-w-2xl border border-overlay flex flex-col h-[90vh]"
          >
            {/* Заголовок */}
            ...
            <div className="p-4 bg-base/50 rounded-b-xl flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-semibold bg-brand text-white rounded-lg hover:bg-blue-600 transition-colors"
              >
                Сохранить
              </button>
            </div>

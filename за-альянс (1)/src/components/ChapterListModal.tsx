...
const ChapterListModal: React.FC<{
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Список глав" confirmText="Закрыть" onConfirm={onClose}>
            <div className="flex flex-col h-[60vh]">
                ...
                <div className="flex-1 overflow-y-auto space-y-2 pr-2">
                    {filteredChapters.map(chapter => (
                        ...
                        >
                            <p className="font-medium text-sm">Глава {chapter.chapterNumber}</p>

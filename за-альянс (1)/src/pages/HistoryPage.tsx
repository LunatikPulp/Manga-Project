                            ...
                            {items.map((item, index) => {
                                ...
                                return (
                                    <div key={index} className="flex items-center gap-4 p-2 rounded-lg hover:bg-surface transition-colors">
                                        ...
                                        <div className="w-1 h-8 bg-surface rounded-full"></div>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-text-secondary mt-1">Прочитана Глава {chapter ? chapter.chapterNumber : item.chapterId}</p>
                                        </div>
                                    </div>
                                );
                            })}
